# From: https://github.com/tensorflow/models/blob/master/research/autoencoder/autoencoder_models/Autoencoder.py
...
class Autoencoder(object):
    ...
    def _initialize_weights(self):
        ...
        for layer in range(len(self.n_layers) - 1):
            w = tf.Variable(
                initializer(
                    (self.n_layers[layer], self.n_layers[layer + 1]), dtype=tf.float32
                )
            )
